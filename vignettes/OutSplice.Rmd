...
The OutSplice_TCGA function has 5 required inputs and 6 optional Inputs and 
...
OutSplice_TCGA(junction, gene_expr, rawcounts, output_file_prefix, dir, filterSex=TRUE, annotation = 'org.Hs.eg.db', TxDb = 'TxDb.Hsapiens.UCSC.hg19.knownGene', offsets_value=0.00001, correction_setting='fdr', p_value=0.05)
```
...
normal samples for significant events. The data for these plots comes from the raw junction input, the
