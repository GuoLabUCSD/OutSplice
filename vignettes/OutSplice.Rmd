...
5. org.Mm.eg.db
6. Repitools
7. TxDb.Mmusculus.UCSC.mm10.knownGene
8. TxDb.Mmusculus.UCSC.mm39.refGene
9. TxDb.Hsapiens.UCSC.hg19.knownGene
10. TxDb.Hsapiens.UCSC.hg38.knownGene
...
1. Download the tarball from GitHub - (wget https://github.com/GuoLabUCSD/OutSplice/tarball/GenePatternNotebook -O OutSplice.tar.gz)
