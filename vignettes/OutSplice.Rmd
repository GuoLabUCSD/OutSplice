...
4. org.Hs.eg.db
5. Repitools
6. TxDb.Hsapiens.UCSC.hg19.knownGene
...
packages must first be loaded using library() before executing the function.

Ex) For mouse genomes aligned to mm39 the user should install, load, and specify
"Mus.musculus" for the genome argument, "org.Mm.eg.db" for the annotation argument, and 
