...
OutSplice(junction, gene_expr, rawcounts, sample_labels, output_file_prefix, dir, filterSex=T, genome='Homo.sapiens', annotation='org.Hs.eg.db', TxDb=TxDb_hg19, offsets_value=0.00001, correction_setting='fdr', p_value=0.05)
```
...
OutSplice_TCGA(junction, gene_expr, rawcounts, output_file_prefix, dir, filterSex=T, genome = 'Homo.sapiens', annotation = 'org.Hs.eg.db', TxDb = 'TxDb.Hsapiens.UCSC.hg19.knownGene', offsets_value=0.00001, correction_setting='fdr', p_value=0.05)
```
...
```{r, results="hide", warning=FALSE, messages=FALSE}
data_file <- system.file("extdata", "OutSplice_Vignette_Output", "OutSplice_Example_2023-01-06.RDA", package = "OutSplice")
...
PlotJunctionData(data_file, NUMBER=1, junctions=ecm1_junc, tail=NULL, p_value = 0.05, GENE=F, SYMBOL=NULL, makepdf=T, pdffile = pdf_output, tumcol='red', normcol='blue')
```
