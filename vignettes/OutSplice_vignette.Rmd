...
5. org.Hs.eg.db
6. Repitools
7. TxDb.Hsapiens.UCSC.hg38.knownGene
...
This algorithm is compatible with any organism provided the genome object, genome wide annotation, and transcript annotations exist as packages on Bioconductor.
...
Outputs an RData file with the following data:
  ...
  -junc.Outliers: list containing the logical matrices TumorOverExpression and TumorUnderExpression. "True" indicates an overexpressed event in TumorOverExpression, or an underexpressed event in TumorUnderExpression.
  ...
  -splice_burden: matrix containing the number of Fisher-P significant overexpressed, underexpressed, and total number of outliers per sample
  -NORM.RSEM.norm: Median of Junction Data Normalized by RSEM for Normal Samples Only (Used for Junction Plotting Only)
