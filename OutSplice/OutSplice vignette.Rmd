...
```
  ...
  -rawcounts: filepath to the reads per million counts (RPM) for each gene. Can be either per gene, or a summed total.
  ...
  -dir: string containing the output directory for the results
